...
import { dipolarCoupling, dipolarTensor, jCoupling, jCouplingTensor } from './utils-nmr';
...
export { chainClasses, useId, CallbackMerger, getColorScale, mergeOnly, saveImage, 
        ...
        regularExpressions, dipolarCoupling, dipolarTensor, jCoupling, jCouplingTensor,
        averagePosition, centerDisplayed, rotationBetween, eulerFromRotation, 
